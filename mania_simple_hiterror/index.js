    ...
    if (cur_combo !== data.gameplay.combo.current) {
        ...
        if (tempHitErrorArrayLength !== tempSmooth.length) {
            ...
            for(var b = preHitErrorArrayLength; b < tempHitErrorArrayLength; b++){
                tickPos.push((data.gameplay.hits.hitErrorArray[b] / fullPos * 512));
            ...
            // s: adjust arrow
            arrow.style.transform = `translateX(${(tempAvg / fullPos) * 517}px)`;
            if((tempAvg / fullPos) * 517 > 2.5){
                arrow.style.borderColor = "#FFB3B3 transparent transparent transparent"
            }
            else if((tempAvg / fullPos) * 517 < -2.5){
                arrow.style.borderColor = "#bfffb9 transparent transparent transparent"
            }
            else{
